...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bizAppvsionController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
                            <t:dictSelect field="appId"  defaultVal="${bizAppvsionPage.appId}"  dictTable="biz_appmanage"  dictField="id" dictText="name" title="APP名称"></t:dictSelect>
					...
					<tr>
						...
						<td class="value">
						    <input id="appV" name="appV" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${bizAppvsionPage.appV}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
		<table id="app_file_fileTable"></table>
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				function appFileOnUploadStart(file){
					...
					<tr>
						...
						<td class="value" >
						  	 	<textarea id="note" style="height:auto;width:95%;" class="inputxt" rows="6" name="note"  ignore="ignore" >${bizAppvsionPage.note}</textarea>
							<span class="Validform_checktip"></span>
	  	...
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "bizAppvsionController.do?getFiles&id=" +  cgFormId,
