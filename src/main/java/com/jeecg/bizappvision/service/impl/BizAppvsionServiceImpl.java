package com.jeecg.bizappvision.service.impl;
...
@Service("bizAppvsionService")
@Transactional
public class BizAppvsionServiceImpl extends CommonServiceImpl implements BizAppvsionServiceI {
